        ...
        createThePollButton.setOnClickListener{
            ...
            if (fragmentManager != null) {
                fragmentManager.beginTransaction()
                    .replace(com.example.dsideapp.R.id.fragment_view, CreatePollFragment()).commit()
                Log.w("Made it here", "!")
           ...
           // val focusable = true // lets taps outside the popup also dismiss it
            ...
            exitButton.setOnClickListener{
               // popupWindow.dismiss()
                ...
                if (fragmentManager != null) {
                    fragmentManager.beginTransaction()
                        .replace(com.example.dsideapp.R.id.fragment_view, PollsFragment()).commit()
                    Log.w("Made it here", "!")
                    pleaseWorkManager = fragmentManager
                }
            }*/
            ...
            createButton.setOnClickListener {
                    ...
                    Log.w("IDK WHY YOU ARE HERE: ",fragmentManager.toString())
                    if (fragmentManager != null) {
                        fragmentManager.beginTransaction().replace(com.example.dsideapp.R.id.fragment_view,  CreatePollFragment()).commit()
                        Log.w("Made it here","!")
                        pleaseWorkManager = fragmentManager
                    }
                else{
